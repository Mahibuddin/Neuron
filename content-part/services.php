...
<?php
	$ser_title = cs_get_option('service_title');
	$ser_sub_title = cs_get_option('service_sub_title');
?>

<section class="section-padding <?php if(!is_page(9)) : ?>darker-bg<?php endif; ?>">
	<div class="container">
		<div class="row">
			<div class="col-md-offset-2 col-md-8 col-lg-offset-3 col-lg-6">
				<div class="template-title text-center">
					<h2><?php echo $ser_title; ?></h2>
					<?php echo wpautop($ser_sub_title); ?>
				</div>
			</div>
		</div>
